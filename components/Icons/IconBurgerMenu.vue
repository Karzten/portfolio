<template>
  <svg aria-hidden="true" class="h-10 w-10" focusable="false" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
    <path
...
.line3.active {
    transform: rotate(-45deg) translateX(-55%) translateY(-5%);
}
</style>